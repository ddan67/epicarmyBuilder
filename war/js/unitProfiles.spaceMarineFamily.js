...
ArmyforgeUnitProfiles.spaceMarineFamily = {
	...
	profiles: {
		...
		captain:{name:'Captain',type:'CH',speed:'n/a',armour:'n/a',cc:'n/a',ff:'n/a',weapons:[{name:'Power Weapon',range:'base contact',firepower:'Assault Weapons',notes:['EA(+1)','MW']}],abilities:['Commander']},
		chaplain:{name:'Chaplain',type:'CH',speed:'n/a',armour:'n/a',cc:'n/a',ff:'n/a',weapons:[{name:'Crozius Arcanum',range:'base contact',firepower:'Assault Weapons',notes:['EA(+1)','MW']}],abilities:['Inspiring']},
		librarian:{name:'Librarian',type:'CH',speed:'n/a',armour:'n/a',cc:'n/a',ff:'n/a',weapons:[{name:'Force Weapon',range:'base contact',firepower:'Assault Weapons',notes:['EA(+1)','MW']},{name:'Psychic Attack',range:'30cm',firepower:'AP5+/AT5+',notes:['MW']}],abilities:['Psyker']},
		supreme_commander:{name:'Supreme Commander',type:'CH',speed:'n/a',armour:'n/a',cc:'n/a',ff:'n/a',weapons:[{name:'Master-crafted Power Weapon',range:'base contact',firepower:'Assault Weapons',notes:['EA(+1)','MW']}],abilities:['Commander','Inspiring','Leader','Supreme Commander']},
