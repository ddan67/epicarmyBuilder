...
ArmyforgeUnitProfiles.smImperialFists = {
	armyIds: ['SM_impfists_NETEA'],
	profiles: {
		...
		scouts:{name:'Scouts',type:'INF',speed:'15cm',armour:'5+',cc:'5+',ff:'4+',weapons:[{name:'Heavy Bolter',range:'30cm',firepower:'AP5+',notes:[]}],abilities:['Infiltrator','Scout']},
		terminators:{name:'Terminators',type:'INF',speed:'15cm',armour:'4+',cc:'3+',ff:'3+',weapons:[{name:'Storm Bolters',range:'15cm',firepower:'AP5+/AT5+',notes:[]}],abilities:['Reinforced Armour','Teleport']},
		...
		landspeeder_tornado:{name:'Land Speeder Tornado',type:'LV',speed:'35cm',armour:'4+',cc:'6+',ff:'5+',weapons:[{name:'Assault Cannon',range:'30cm',firepower:'AP5+/AT5+',notes:[]},{name:'Heavy Bolter',range:'30cm',firepower:'AP5+',notes:[]}],abilities:['Scout','Skimmer']},
		landspeeder_typhoon:{name:'Land Speeder Typhoon',type:'LV',speed:'35cm',armour:'4+',cc:'6+',ff:'5+',weapons:[{name:'Twin Typhoon Missile',range:'45cm',firepower:'AP3+/AT5+',notes:[]},{name:'Heavy Bolter',range:'30cm',firepower:'AP5+',notes:[]}],abilities:['Scout','Skimmer']},
		...
		predator_annihilator:{name:'Predator Annihilator',type:'AV',speed:'30cm',armour:'4+',cc:'6+',ff:'5+',weapons:[{name:'Twin Lascannon',range:'45cm',firepower:'AT4+',notes:[]},{name:'2x Lascannon',range:'45cm',firepower:'AT5+',notes:[]}],abilities:[]},
		...
		techmarine:{name:'Techmarine',type:'CH',speed:'n/a',armour:'n/a',cc:'n/a',ff:'n/a',weapons:[{name:'Power Weapon',range:'(bc)',firepower:'Assault Weapons',notes:['EA(+1)','MW']}],abilities:['Leader','If added to a Bastion unit the Bastion gains 1 Void Shield.']},
		...
		land_raider_crusader:{name:'Land Raider Crusader',type:'AV',speed:'25cm',armour:'4+',cc:'5+',ff:'5+',weapons:[{name:'2x Hurricane Bolters',range:'(15cm)',firepower:'Small Arms',notes:['EA(+1)']},{name:'Twin Assault Cannon',range:'30cm',firepower:'AP4+/AT4+',notes:[]}],abilities:['Reinforced Armour','Thick Rear Armour','Transport','May transport three infantry units without Jump Packs or Mounted ; Terminator units count as one and a half units each, rounding up. Counts as a Land Raider for the purposes of being transported.']},
		land_raider_achilles:{name:'Land Raider Achilles',type:'AV',speed:'25cm',armour:'4+',cc:'6+',ff:'4+',weapons:[{name:'Thunderfire Cannon',range:'60cm',firepower:'2x AP4+/AT6+',notes:['D']},{name:'Thunderfire Cannon',range:'60cm',firepower:'2x AP4+/AT6+',notes:['IC']},{name:'2x Twin Multi-melta',range:'15cm',firepower:'MW4+',notes:[]},{name:'2x Twin Multi-melta',range:'(15cm)',firepower:'Small Arms',notes:['MW']}],abilities:['Reinforced Armour','Thick Rear Armour','Transport','May transport one Terminator unit or two infantry units without Jump Packs or Mounted .']},
		...
		thunderhawk_sat:{name:'Thunderhawk (Saturation Bombing configuration)',type:'AC/WE',speed:'Bomber',armour:'4+',cc:'-',ff:'-',weapons:[{name:'Battle Cannon',range:'75cm',firepower:'AP4+/AT4+',notes:['FxF']},{name:'2x Twin Heavy Bolter',range:'30cm',firepower:'AP4+',notes:['FxF']},{name:'Twin Heavy Bolter',range:'15cm',firepower:'AP4+/AA5+',notes:['Left']},{name:'Twin Heavy Bolter',range:'15cm',firepower:'AP4+/AA5+',notes:['Right']},{name:'Bombs',range:'15cm',firepower:'2BP',notes:['FxF','IC']}],abilities:['Damage Capacity 2','Reinforced Armour','Critical Hit Effect: Destroyed.']},
		...
		marauder_bomber:{name:'Marauder Bomber',type:'AC',speed:'Bomber',armour:'4+',cc:'n/a',ff:'n/a',weapons:[{name:'Twin Lascannon',range:'45cm',firepower:'AT4+/AA4+',notes:['FxF']},{name:'Bomb Racks',range:'15cm',firepower:'3BP',notes:['FxF']},{name:'2× Twin Heavy Bolter',range:'15cm',firepower:'AA5+',notes:[]}],abilities:[]},
		storm_talon_gunship:{name:'Storm Talon Gunship',type:'AC',speed:'Fighter',armour:'5+',cc:'-',ff:'-',weapons:[{name:'Twin Assault Cannon',range:'30cm',firepower:'AP4+/AT4+/AA5+',notes:['FwA']},{name:'Twin Heavy Bolter',range:'15cm',firepower:'AP4+/AA5+',notes:['FxF']}],abilities:[]},
		...
		thunderfire_cannon:{name:'Thunderfire Cannon',type:'INF',speed:'10cm',armour:'5+',cc:'6+',ff:'5+',weapons:[{name:'Thunderfire Cannon',range:'60cm',firepower:'2× AP4+/AT6+',notes:['D']},{name:'Thunderfire Cannon',range:'60cm',firepower:'2× AP4+/AT6+',notes:['IC']}],abilities:[]},
		rapier:{name:'Rapier',type:'INF',speed:'10cm',armour:'5+',cc:'6+',ff:'5+',weapons:[{name:'Laser Destroyer',range:'45cm',firepower:'AP6+/AT4+',notes:[]}],abilities:['Counts as two infantry units for transport']},
		thudd_gun:{name:'Thudd Gun',type:'INF',speed:'10cm',armour:'5+',cc:'6+',ff:'5+',weapons:[{name:'Thudd Gun',range:'45cm',firepower:'AP4+/AT6+',notes:['Ind']}],abilities:['Counts as two infantry units for transport']},
		centurion:{name:'Centurion',type:'INF',speed:'15cm',armour:'4+',cc:'4+',ff:'4+',weapons:[{name:'Heavy Bolters',range:'30cm',firepower:'AP5+',notes:[]},{name:'Siege Drills',range:'base contact',firepower:'Assault Weapons',notes:['EA(+1)']}],abilities:['Reinforced Armour']},
		...
		reaver_titan:{name:'Reaver Class Titan',type:'WE',speed:'20cm',armour:'4+',cc:'3+',ff:'3+',weapons:[{name:'Titan Weapons',range:'varies',firepower:'varies',notes:['Configuration-dependent']}],abilities:['Damage Capacity 6','Reinforced Armour','Void Shields','Walker']},
		warlord_titan:{name:'Warlord Class Titan',type:'WE',speed:'15cm',armour:'4+',cc:'2+',ff:'3+',weapons:[{name:'Titan Weapons',range:'varies',firepower:'varies',notes:['Configuration-dependent']}],abilities:['Damage Capacity 8','Reinforced Armour','Void Shields','Walker']},
		fellblade:{name:'Fellblade',type:'WE',speed:'15cm',armour:'4+',cc:'6+',ff:'4+',weapons:[{name:'2x Accelerator Cannon',range:'75cm',firepower:'MW3+',notes:[]},{name:'Quad Lascannon',range:'45cm',firepower:'2x AT4+',notes:['Left']},{name:'Quad Lascannon',range:'45cm',firepower:'2x AT4+',notes:['Right']},{name:'Demolisher',range:'30cm',firepower:'AP3+/AT4+',notes:['FxF','IC']},{name:'Twin Heavy Bolter',range:'30cm',firepower:'AP4+',notes:['FxF']}],abilities:['Damage Capacity 4','Reinforced Armour','Critical Hit Effect: Destroyed. All units within 5cm of the model suffer a hit on a roll of 6+.']},
		bastion:{name:'Bastion',type:'WE',speed:'Immobile',armour:'4+',cc:'-',ff:'5+',weapons:[{name:'Thunderfire Cannon',range:'60cm',firepower:'2x AP4+/AT6+',notes:['D']},{name:'Thunderfire Cannon',range:'60cm',firepower:'2x AP4+/AT6+',notes:['IC']},{name:'Twin Hyperios Launcher',range:'45cm',firepower:'AT5+/AA4+',notes:[]},{name:'2x Twin Heavy Bolter',range:'30cm',firepower:'AP4+',notes:[]}],abilities:['Damage Capacity 3','Fearless','Reinforced Armour','Thick Rear Armour','Transport','May transport eight infantry units or Dreadnoughts; Terminator units and Dreadnoughts count as two units each. Transported units do not have to disembark in order to shoot or use their firefight value if this unit is able to shoot, assault or lend support. The unit counts as rubble once it is destroyed. Critical Hit Effect: The unit takes an extra point of damage.']},
...
ArmyforgeUnitProfiles.findSmImperialFistsProfileByName = function(displayName, listId) {
	if (!displayName) {
		return null;
	}
	if (listId && !ArmyforgeUnitProfiles.smImperialFists.armyIds.member(listId)) {
		return null;
	}
	var normalized = ArmyforgeUnitProfiles.normalizeSpaceMarineListName(displayName);
	var key = ArmyforgeUnitProfiles.smImperialFists.nameToKey[normalized];
	if (!key) {
		return null;
	}
	return ArmyforgeUnitProfiles.smImperialFists.profiles[key] || null;
};
