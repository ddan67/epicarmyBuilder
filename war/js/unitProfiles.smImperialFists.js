...
ArmyforgeUnitProfiles.smImperialFists = {
	...
	profiles: {
		...
		land_raider_crusader:{name:'Land Raider Crusader',type:'AV',speed:'25cm',armour:'4+',cc:'5+',ff:'5+',weapons:[{name:'2× Hurricane Bolters',range:'15cm',firepower:'Small Arms',notes:['EA(+1)']},{name:'Twin Assault Cannon',range:'30cm',firepower:'AP4+/AT4+',notes:[]}],abilities:['Reinforced Armour','Thick Rear Armour','Transport']},
		...
		thunderhawk_sat:{name:'Thunderhawk (Saturation Bombing configuration)',type:'AC/WE',speed:'n/a',armour:'4+',cc:'6+',ff:'4+',weapons:[{name:'Bomb Racks',range:'15cm',firepower:'3BP',notes:['FxF']}],abilities:['Damage Capacity 3','Planetfall','Transport']},
		...
		fellblade:{name:'Fellblade',type:'WE',speed:'15cm',armour:'4+',cc:'6+',ff:'4+',weapons:[{name:'Fellblade Cannon',range:'75cm',firepower:'AP4+/AT4+',notes:[]}],abilities:['Damage Capacity 3','Reinforced Armour']},
