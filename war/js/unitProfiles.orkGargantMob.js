...
ArmyforgeUnitProfiles.orkGargantMob = {
	...
	profiles: {
		...
		deth_kannon: {name:'Deth Kannon', type:'CH', speed:'n/a', armour:'n/a', cc:'n/a', ff:'n/a', weapons:[{name:'Deth Kannon', range:'90cm', firepower:'MW3+', notes:['TK(D3)']}], abilities:[]},
		gatling_cannon: {name:'Gatling Cannon', type:'CH', speed:'n/a', armour:'n/a', cc:'n/a', ff:'n/a', weapons:[{name:'Gatling Cannon', range:'45cm', firepower:'6x AP5+/AT5+', notes:[]}], abilities:[]},
		krooz_missiles: {name:'Krooz Missiles', type:'CH', speed:'n/a', armour:'n/a', cc:'n/a', ff:'n/a', weapons:[{name:'2x Krooz Missile', range:'Unlimited', firepower:'MW3+', notes:['Ind','SS','TK(D3)']}], abilities:[]},
		krusha: {name:'Krusha', type:'CH', speed:'n/a', armour:'n/a', cc:'n/a', ff:'n/a', weapons:[{name:'Krusha', range:'(bc)', firepower:'Assault Weapons', notes:['EA(+D3)','TK(D3)']}], abilities:[]},
		lifta_droppa: {name:'Lifta-Droppa', type:'CH', speed:'n/a', armour:'n/a', cc:'n/a', ff:'n/a', weapons:[{name:'Lifta-Droppa', range:'60cm', firepower:'MW3+', notes:['TK(D3)']},{name:'Lifta-Droppa', range:'(bc)', firepower:'Assault Weapons', notes:['EA(+1)','TK(D3)']}], abilities:[]},
		loadz_o_guns: {name:'Loadz o\' Guns', type:'CH', speed:'n/a', armour:'n/a', cc:'n/a', ff:'n/a', weapons:[{name:'2-4x Big Gun', range:'45cm', firepower:'AP5+/AT5+', notes:[]},{name:'0-1x Skorcha', range:'15cm', firepower:'AP4+', notes:['IC']},{name:'0-1x Skorcha', range:'(15cm)', firepower:'Small Arms', notes:['EA(+1)','IC']},{name:'0-1x Flak Gun', range:'30cm', firepower:'2x AP6+/AT6+/AA6+', notes:[]}], abilities:['Armed with four Big Guns, one of which may be replaced with a Skorcha and another of which may be replaced with a Flak Gun.']},
		mega_choppa: {name:'Mega-Choppa', type:'CH', speed:'n/a', armour:'n/a', cc:'n/a', ff:'n/a', weapons:[{name:'Mega-Choppa', range:'45cm', firepower:'AP5+/AT5+', notes:[]},{name:'Mega-Choppa', range:'(bc)', firepower:'Assault Weapons', notes:['EA(+1)','TK(D3)']}], abilities:[]},
		mega_lobba: {name:'Mega-Lobba', type:'CH', speed:'n/a', armour:'n/a', cc:'n/a', ff:'n/a', weapons:[{name:'Mega-Lobba', range:'60cm', firepower:'D3+3BP', notes:[]}], abilities:[]},
		soopagun: {name:'Soopagun', type:'CH', speed:'n/a', armour:'n/a', cc:'n/a', ff:'n/a', weapons:[{name:'Soopagun', range:'60cm', firepower:'2BP', notes:['MW']}], abilities:[]},
		snappa: {name:'Snappa', type:'CH', speed:'n/a', armour:'n/a', cc:'n/a', ff:'n/a', weapons:[{name:'Snappa', range:'(15cm)', firepower:'Small Arms', notes:['EA(+2)','IC']},{name:'Snappa', range:'(bc)', firepower:'Assault Weapons', notes:['EA(+1)','TK(D3)']}], abilities:[]},
		supa_lifta_droppa: {name:'Supa-Lifta-Droppa', type:'CH', speed:'n/a', armour:'n/a', cc:'n/a', ff:'n/a', weapons:[{name:'Supa-Lifta-Droppa', range:'45cm', firepower:'MW4+', notes:['TK(D6)']}], abilities:[]},
	...
	nameToKey: {
		...
		'deth kannon':'deth_kannon','gatling cannon':'gatling_cannon','krooz missiles':'krooz_missiles','krusha':'krusha','lifta droppa':'lifta_droppa','loadz o guns':'loadz_o_guns','mega choppa':'mega_choppa','mega lobba':'mega_lobba','soopagun':'soopagun','snappa':'snappa','supa lifta droppa':'supa_lifta_droppa','supa zzap gun':'supa_zzap_gun','twin soopagun':'twin_soopagun','ultra lobba':'ultra_lobba',
