...
ArmyforgeUnitProfiles.smScionsOfIron = {
	...
	profiles: {
		...
		land_raider_helios:{name:'Land Raider Helios',type:'AV',speed:'25cm',armour:'4+',cc:'6+',ff:'5+',weapons:[{name:'2× Twin Lascannon',range:'45cm',firepower:'AT4+',notes:[]},{name:'Whirlwind',range:'45cm',firepower:'1BP',notes:['Ind']}],abilities:['Reinforced Armour','Thick Rear Armour','Transport']},
		...
		thunderhawk_cas:{name:'Thunderhawk (Close Air Support configuration)',type:'AC/WE',speed:'Bomber',armour:'4+',cc:'-',ff:'-',weapons:[{name:'Turbo-laser',range:'45cm',firepower:'2x AP5+/AT3+',notes:['FxF']},{name:'2x Twin Heavy Bolter',range:'30cm',firepower:'AP4+/AA5+',notes:['FxF']},{name:'Twin Heavy Bolter',range:'15cm',firepower:'AP4+/AA5+',notes:['Left']},{name:'Twin Heavy Bolter',range:'15cm',firepower:'AP4+/AA5+',notes:['Right']},{name:'2x Underwing Rockets',range:'30cm',firepower:'AT4+',notes:['FxF']}],abilities:['Damage Capacity 2','Reinforced Armour','Critical Hit Effect: Destroyed.']},
		thunderhawk_transporter:{name:'Thunderhawk Transporter',type:'AC/WE',speed:'Bomber',armour:'5+',cc:'6+',ff:'5+',weapons:[{name:'2x Twin Heavy Bolter',range:'30cm',firepower:'AP4+/AA5+',notes:[]}],abilities:['Damage Capacity 2','Planetfall','Reinforced Armour','Transport','May transport two armoured vehicles (except Dreadnoughts) plus the units they can carry; Land Raiders count as two units each. Critical Hit Effect: The unit and all units being carried are destroyed. Counts as a Landing Craft for the purposes of being transported.']},
		...
		warhound_titan:{name:'Warhound Class Titan',type:'WE',speed:'30cm',armour:'5+',cc:'4+',ff:'4+',weapons:[{name:'Titan Weapons',range:'varies',firepower:'varies',notes:['Configuration-dependent']}],abilities:['Damage Capacity 2','Reinforced Armour','Void Shields','Walker']},
		...
		warlord_titan:{name:'Warlord Class Titan',type:'WE',speed:'15cm',armour:'4+',cc:'2+',ff:'3+',weapons:[{name:'Titan Weapons',range:'varies',firepower:'varies',notes:['Configuration-dependent']}],abilities:['Damage Capacity 6','Reinforced Armour','Void Shields','Walker']},
