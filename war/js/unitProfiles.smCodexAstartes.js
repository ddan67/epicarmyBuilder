...
ArmyforgeUnitProfiles.smCodexAstartes = {
	...
	profiles: {
		...
		devastators:{name:'Devastators',type:'INF',speed:'15cm',armour:'4+',cc:'5+',ff:'3+',weapons:[{name:'2× Missile Launcher',range:'45cm',firepower:'AP5+/AT6+',notes:[]}],abilities:[]},
		...
		terminators:{name:'Terminators',type:'INF',speed:'15cm',armour:'4+',cc:'3+',ff:'3+',weapons:[{name:'2× Assault Cannon',range:'30cm',firepower:'AP5+/AT5+',notes:[]},{name:'Power Weapons',range:'base contact',firepower:'Assault Weapons',notes:['EA(+1)','MW']}],abilities:['Reinforced Armour','Teleport']},
		...
		predator_annihilator:{name:'Predator Annihilator',type:'AV',speed:'30cm',armour:'4+',cc:'6+',ff:'5+',weapons:[{name:'Twin Lascannon',range:'45cm',firepower:'AT4+',notes:[]},{name:'2× Lascannon',range:'45cm',firepower:'AT5+',notes:[]}],abilities:[]},
