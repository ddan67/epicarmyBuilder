...
ArmyforgeUnitProfiles.orkWarHorde = {
	...
	profiles: {
		...
		landa: {name:'Landa', type:'AC/WE Bomber', speed:'n/a', armour:'5+', cc:'6+', ff:'4+', weapons:[{name:'Gun Turrets', range:'15cm', firepower:'D6+3× AP5+/AA6+', notes:[]},{name:'2× Tankbusta Rokkits', range:'30cm', firepower:'AT4+', notes:['FxF']}], abilities:['Damage Capacity 3','Planetfall','Reinforced Armour','Transport']},
